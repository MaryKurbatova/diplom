...
-- Только один тип платы - "Плата"
INSERT INTO board_type (code, name, description) VALUES
('BOARD', 'Плата', 'Основная плата устройства');
...
('CASE-RS-2023-001', 'RS-корпус'),
('CASE-RS-2023-002', 'RS-корпус'),
('CASE-SA-2023-001', 'SA-корпус'),
('CASE-SA-2023-002', 'SA-корпус');

-- Платы (формат PB-ТИП-ГОД-НОМЕР)
...
(1,'PB-RS-2023-001','assembled',TRUE,'2023-01-10 09:00:00',1,TRUE,'2023-01-11 10:00:00',2,TRUE,'2023-01-12 11:00:00',3),
(1,'PB-RS-2023-002','assembled',TRUE,'2023-02-10 09:00:00',1,TRUE,'2023-02-11 10:00:00',2,TRUE,'2023-02-12 11:00:00',3),
(1,'PB-SA-2023-001','assembled',TRUE,'2023-03-10 09:00:00',7,TRUE,'2023-03-11 10:00:00',2,TRUE,'2023-03-12 11:00:00',3),
(1,'PB-SA-2023-002','assembled',TRUE,'2023-04-10 09:00:00',7,TRUE,'2023-04-11 10:00:00',2,TRUE,'2023-04-12 11:00:00',3),
(1,'PB-RS-2024-010','new',FALSE,NULL,NULL,FALSE,NULL,NULL,FALSE,NULL,NULL),
(1,'PB-SA-2024-010','new',FALSE,NULL,NULL,FALSE,NULL,NULL,FALSE,NULL,NULL),
(1,'PB-RS-2024-020','visual_fail',FALSE,'2024-06-01 09:00:00',1,FALSE,NULL,NULL,FALSE,NULL,NULL),
(1,'PB-SA-2024-020','diagnostics_fail',TRUE,'2024-06-01 09:30:00',1,FALSE,'2024-06-02 10:00:00',2,FALSE,NULL,NULL);
...
-- Привязка плат
UPDATE boards SET device_id=1 WHERE serial_number = 'PB-RS-2023-001';
UPDATE boards SET device_id=2 WHERE serial_number = 'PB-RS-2023-002';
UPDATE boards SET device_id=3 WHERE serial_number = 'PB-SA-2023-001';
UPDATE boards SET device_id=4 WHERE serial_number = 'PB-SA-2023-002';

-- MAC-адреса
INSERT INTO macs (device_id, mac_address, interface_name, assignment_date) VALUES
(1,'00:1B:44:11:3A:B7','eth0','2023-01-15'),
(1,'00:1B:44:11:3A:B8','eth1','2023-01-15'),
(2,'00:1B:44:11:3A:B9','eth0','2023-02-20'),
(2,'00:1B:44:11:3A:BA','eth1','2023-02-20'),
(3,'00:1C:44:11:3A:D1','eth0','2023-03-15'),
(3,'00:1C:44:11:3A:D2','eth1','2023-03-15'),
(3,'00:1C:44:11:3A:D3','management','2023-03-15'),
(4,'00:1C:44:11:3A:E1','eth0','2023-04-20'),
(4,'00:1C:44:11:3A:E2','eth1','2023-04-20');

-- Журналы
INSERT INTO visual_inspection_records (board_id, employee_id, inspection_date, result, comment) VALUES
(1,1,'2023-01-10 09:00:00',TRUE,'OK'),
(2,1,'2023-01-10 09:30:00',TRUE,'OK'),
(3,7,'2023-03-10 09:00:00',TRUE,'OK'),
(4,7,'2023-04-10 09:00:00',TRUE,'OK'),
(7,1,'2024-06-01 09:00:00',FALSE,'Брак пайки');
...
(3,2,'2023-03-11 10:00:00',TRUE,'Все ОК','192.168.1.103','Стенд Д-1',TRUE,TRUE,TRUE,TRUE),
(4,2,'2023-04-11 10:00:00',TRUE,'Все ОК','192.168.1.104','Стенд Д-1',TRUE,TRUE,TRUE,TRUE),
(8,2,'2024-06-02 10:00:00',FALSE,'Ошибка теста портов','192.168.1.105','Стенд Д-1',FALSE,TRUE,TRUE,TRUE);
...
(3,'SA501175220001','Полный цикл завершён','packaged',5,'2023-03-14 12:00:00');
